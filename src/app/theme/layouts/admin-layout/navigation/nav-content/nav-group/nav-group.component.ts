...
export class NavGroupComponent implements OnInit {
  ...
  constructor(private location: Location, private authService: AuthService) {
    const modulePermissionTemp = authService.getUserPermissionModules();
    if (modulePermissionTemp && Array.isArray(modulePermissionTemp)) {
      this.modulePermissions = modulePermissionTemp;
    }
  }
